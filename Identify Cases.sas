...
/*	Data Processing*/
	...
	ARRAY pr pr1-pr15; 
		DO over pr;
			IF substr(pr,1,3) = '996' THEN cv_flag = 1;
		END;
		...
		do over dx;
			*CHADS2VASC score;
			if substr(dx,1,3) = '428' 
				or substr(dx,1,5) in ('39891', '40201', '40211', '40291', '40403', '40411', '40413', '40491', '40493') 
					then flag_chf	= 1;
			...
			if substr(dx,1,3) in ('434', '435') 
				or substr(dx,1,5) in ('43301', '43311', '43321', '43331', '43391', 'v1254') 
					then flag_strk = 2;
			if substr(dx,1,2) = '11' 
				or substr(dx,1,3) in ('433', '410', '412', '413', '414', '436', '437', '438', '433', '440') 
				or substr(dx,1,4) in ('4471', '5571', '5579') 
					then flag_vasc = 1;
